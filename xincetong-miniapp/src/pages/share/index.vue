<template>
  <view class="page page-bg">
    ...
    <view class="content">
      ...
      <view class="subtitle">生成海报 + 二维码</view>

      <view class="placeholder">本页面在阶段 5 实现</view>
      <view class="placeholder-sub">管理后台 H5 + 合规配置</view>
    </view>
...
const title = ref('分享给好友')
const stage = ref('5')
const hint  = ref('生成海报 + 二维码')

const { shareCode, promoterCode } = useShareCode()

onLoad(() => {
  pageView('share/index')
})
