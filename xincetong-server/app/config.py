...
class Settings(BaseSettings):
    ...
    MYSQL_PORT: int = 3306
    MYSQL_USER: str = "xincetong"
    MYSQL_PASSWORD: str = "xincetong"
    MYSQL_DATABASE: str = "xincetong"
    MYSQL_CHARSET: str = "utf8mb4"

    # ===== 数据库覆盖（本地无 MySQL 时设为 sqlite+aiosqlite:///./xincetong.db）=====
    DATABASE_URL: str = ""
